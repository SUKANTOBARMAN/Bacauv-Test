          ...
          <q-card-section>
            ...
            <div class="row items-center q-mb-lg">
              ...
              <div class="col q-pl-md">
                ...
                <div class="text-subtitle1">{{ employee.designationName || employee.designation || 'No Designation' }}</div>
...
const employeeId = computed(() => route.params.id || 'random_employee_id');
...
const fetchEmployeePhoto = async () => {
  try {
    const { data } = await api.get(
      `/v1/files?searchJoin=and&search=owner_type:employee;owner_id:${employeeId.value}`
    );
...
onMounted(() => {
  fetchEmployeeData();
  fetchEmployeePhoto(); // Also call this
});
